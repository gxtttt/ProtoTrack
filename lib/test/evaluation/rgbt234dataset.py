...
class RGBT234Dataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_info):
        ...
        frames_list = [frames_v, frames_i]    
        return Sequence(sequence_info['name'], frames_list, 'rgbt234', ground_truth_rect)
    ...
    def _get_sequence_list(self):
        ...
        for i in range(len(sequence_list)):
            ...
            sequence_info["anno_path"] = os.path.join(sequence_info["path"],'infrared.txt')
